...
func main() {
	...
	// We expect the bootstrapping to give a average precision of 27.9 bits with H=192 (and 24.4 with H=N/2)
	// if the plaintext values are uniformly distributed in [-1, 1] for both the real and imaginary part.
	btpParametersLit := bootstrapping.ParametersLiteral{
		// Same LogN as ckks params. (This is not required.)
		...
		// specify the bootstrapping parameters' secret distribution. (Not necessary.)
		Xs: params.Xs(),
	}
	...
	printResidualParams(btpParams, params)
	...
	printBootstrappingParams(btpParams)
...
func printResidualParams(btpParams bootstrapping.Parameters, params ckks.Parameters) {
...
func printBootstrappingParams(btpParams bootstrapping.Parameters) {
